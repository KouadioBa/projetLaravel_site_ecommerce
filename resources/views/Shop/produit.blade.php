...
<div class="album py-5 bg-light">
  <div class="container">
      ...
      <div class="row">
          <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <img src="{{asset('produits/wonder_woman.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
          ...
          <div class="col-md-4">
              <div class="card mb-4 box-shadow">
                  <img src="{{asset('produits/super_man.jpg')}}" class="card-img-top img-fluid" alt="Responsive image">
